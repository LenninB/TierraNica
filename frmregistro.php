...
<head>
	...
	<title>Login TierraNica!</title>
</head>
<body background="img/golf.jpg">
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 17pt; color:#FFFFFF;"><b>Correo: </b></label></td>
			<td width=80> <input class="form-group has-success" style="border-radius:15px;" type="text" name="mail"></td></tr>
		<tr><td><label style="font-size: 17pt; color:#FFFFFF;"><b>Contraseña: </b></label></td>
